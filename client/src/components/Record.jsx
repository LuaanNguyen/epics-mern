...
export default function Record() {
  ...
  return (
    <>
      <h3 className="text-lg font-semibold p-4">Create/Update Data Record</h3>
      <form
        onSubmit={onSubmit}
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-slate-900/10 pb-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-slate-600">
              According to multiple sources on Goggle, a perfect environment for
              shirmp farming should satisfy the followings:
              <br />- Ideal water temperature: 26 to 30°C
              <br />- Ideal pH Range: 7.0 to 8.5
              <br />- Ideal O2 Concentration: 4 or 5 mg/L or higher
              <br />- Ideal Salinity: 0 to 25 ppt
            </p>
          </div>
